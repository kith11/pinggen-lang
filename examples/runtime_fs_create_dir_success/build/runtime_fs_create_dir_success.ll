...
@.str.1 = private unnamed_addr constant [9 x i8] c"made-dir\00"
@.str.2 = private unnamed_addr constant [18 x i8] c"made-dir/note.txt\00"
@.str.3 = private unnamed_addr constant [7 x i8] c"inside\00"
@.str.4 = private unnamed_addr constant [10 x i8] c"dir-ready\00"

define i32 @main() {
  %1 = getelementptr inbounds [9 x i8], ptr @.str.1, i64 0, i64 0
  %2 = call %enum.FsWriteResult @pinggen_fs_create_dir(ptr %1)
  %3 = extractvalue %enum.FsWriteResult %2, 0
  %4 = icmp eq i64 %3, 0
  br i1 %4, label %match_arm.3, label %match_check.4
match_arm.3:
  %5 = getelementptr inbounds [18 x i8], ptr @.str.2, i64 0, i64 0
  %6 = getelementptr inbounds [7 x i8], ptr @.str.3, i64 0, i64 0
  %7 = call %enum.FsWriteResult @pinggen_fs_write_string(ptr %5, ptr %6)
  %8 = extractvalue %enum.FsWriteResult %7, 0
  %9 = icmp eq i64 %8, 0
  br i1 %9, label %match_arm.8, label %match_check.9
match_arm.8:
  %10 = getelementptr inbounds [10 x i8], ptr @.str.4, i64 0, i64 0
  %11 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %12 = call i32 (ptr, ...) @printf(ptr %11, ptr %10)
  br label %match_end.6
match_check.9:
  %13 = icmp eq i64 %8, 1
  br i1 %13, label %match_arm.10, label %match_unreachable.7
match_arm.10:
  %14 = extractvalue %enum.FsWriteResult %7, 1
  %15 = alloca ptr
  store ptr %14, ptr %15
  %16 = load ptr, ptr %15
...
match_check.4:
  %19 = icmp eq i64 %3, 1
  br i1 %19, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %20 = extractvalue %enum.FsWriteResult %2, 1
  %21 = alloca ptr
  store ptr %20, ptr %21
  %22 = load ptr, ptr %21
