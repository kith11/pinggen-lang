...
@.str.1 = private unnamed_addr constant [16 x i8] c"missing/out.txt\00"
@.str.2 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str.3 = private unnamed_addr constant [3 x i8] c"ok\00"

define i32 @main() {
  %1 = getelementptr inbounds [16 x i8], ptr @.str.1, i64 0, i64 0
  %2 = getelementptr inbounds [6 x i8], ptr @.str.2, i64 0, i64 0
...
match_arm.3:
  %6 = getelementptr inbounds [3 x i8], ptr @.str.3, i64 0, i64 0
  %7 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %8 = call i32 (ptr, ...) @printf(ptr %7, ptr %6)
  br label %match_end.1
match_check.4:
  %9 = icmp eq i64 %4, 1
  br i1 %9, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %10 = extractvalue %enum.FsWriteResult %3, 1
  %11 = alloca ptr
  store ptr %10, ptr %11
  %12 = load ptr, ptr %11
