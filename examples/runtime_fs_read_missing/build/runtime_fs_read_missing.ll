...
@.str.1 = private unnamed_addr constant [12 x i8] c"missing.txt\00"

define i32 @main() {
  %1 = getelementptr inbounds [12 x i8], ptr @.str.1, i64 0, i64 0
  %2 = call %enum.FsResult @pinggen_fs_read_to_string(ptr %1)
  %3 = extractvalue %enum.FsResult %2, 0
  %4 = icmp eq i64 %3, 0
  br i1 %4, label %match_arm.3, label %match_check.4
match_arm.3:
  %5 = extractvalue %enum.FsResult %2, 1
  %6 = alloca ptr
  store ptr %5, ptr %6
  %7 = load ptr, ptr %6
...
match_arm.5:
  %11 = extractvalue %enum.FsResult %2, 2
  %12 = alloca ptr
  store ptr %11, ptr %12
  %13 = load ptr, ptr %12
