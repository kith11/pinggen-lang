...
@.str.1 = private unnamed_addr constant [23 x i8] c"runtime_fs_cwd_success\00"
@.str.2 = private unnamed_addr constant [4 x i8] c"cwd\00"

define i32 @main() {
  %1 = call %enum.FsResult @pinggen_fs_cwd()
  %2 = extractvalue %enum.FsResult %1, 0
  %3 = icmp eq i64 %2, 0
  br i1 %3, label %match_arm.3, label %match_check.4
match_arm.3:
  %4 = extractvalue %enum.FsResult %1, 1
  %5 = alloca ptr
  store ptr %4, ptr %5
  %6 = load ptr, ptr %5
  %7 = getelementptr inbounds [23 x i8], ptr @.str.1, i64 0, i64 0
  %8 = call i32 @pinggen_str_ends_with(ptr %6, ptr %7)
  %9 = icmp ne i32 %8, 0
  br i1 %9, label %if_then.6, label %if_else.7
if_then.6:
  %10 = getelementptr inbounds [4 x i8], ptr @.str.2, i64 0, i64 0
  %11 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %12 = call i32 (ptr, ...) @printf(ptr %11, ptr %10)
  br label %if_end.8
if_else.7:
  %13 = load ptr, ptr %5
  %14 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %15 = call i32 (ptr, ...) @printf(ptr %14, ptr %13)
  br label %if_end.8
if_end.8:
  br label %match_end.1
match_check.4:
  %16 = icmp eq i64 %2, 1
  br i1 %16, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %17 = extractvalue %enum.FsResult %1, 2
  %18 = alloca ptr
  store ptr %17, ptr %18
  %19 = load ptr, ptr %18
  %20 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %21 = call i32 (ptr, ...) @printf(ptr %20, ptr %19)
  br label %match_end.1
match_unreachable.2:
  unreachable
match_end.1:
