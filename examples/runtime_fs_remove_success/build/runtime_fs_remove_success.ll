...
@.str.1 = private unnamed_addr constant [14 x i8] c"delete-me.txt\00"
@.str.2 = private unnamed_addr constant [5 x i8] c"temp\00"
@.str.3 = private unnamed_addr constant [14 x i8] c"delete-me.txt\00"
@.str.4 = private unnamed_addr constant [14 x i8] c"delete-me.txt\00"
@.str.5 = private unnamed_addr constant [12 x i8] c"still-there\00"
@.str.6 = private unnamed_addr constant [8 x i8] c"removed\00"

define i32 @main() {
  %1 = getelementptr inbounds [14 x i8], ptr @.str.1, i64 0, i64 0
  %2 = getelementptr inbounds [5 x i8], ptr @.str.2, i64 0, i64 0
...
match_arm.3:
  %6 = getelementptr inbounds [14 x i8], ptr @.str.3, i64 0, i64 0
  %7 = call %enum.FsWriteResult @pinggen_fs_remove(ptr %6)
  %8 = extractvalue %enum.FsWriteResult %7, 0
  %9 = icmp eq i64 %8, 0
  br i1 %9, label %match_arm.8, label %match_check.9
match_arm.8:
  %10 = getelementptr inbounds [14 x i8], ptr @.str.4, i64 0, i64 0
  %11 = call i1 @pinggen_fs_exists(ptr %10)
  br i1 %11, label %if_then.11, label %if_else.12
if_then.11:
  %12 = getelementptr inbounds [12 x i8], ptr @.str.5, i64 0, i64 0
  %13 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %14 = call i32 (ptr, ...) @printf(ptr %13, ptr %12)
  br label %if_end.13
if_else.12:
  %15 = getelementptr inbounds [8 x i8], ptr @.str.6, i64 0, i64 0
...
match_check.9:
  %18 = icmp eq i64 %8, 1
  br i1 %18, label %match_arm.10, label %match_unreachable.7
match_arm.10:
  %19 = extractvalue %enum.FsWriteResult %7, 1
  %20 = alloca ptr
  store ptr %19, ptr %20
  %21 = load ptr, ptr %20
...
match_check.4:
  %24 = icmp eq i64 %4, 1
  br i1 %24, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %25 = extractvalue %enum.FsWriteResult %3, 1
  %26 = alloca ptr
  store ptr %25, ptr %26
  %27 = load ptr, ptr %26
  %28 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %29 = call i32 (ptr, ...) @printf(ptr %28, ptr %27)
  br label %match_end.1
match_unreachable.2:
  unreachable
match_end.1:
