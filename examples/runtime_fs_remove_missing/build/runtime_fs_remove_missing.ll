...
@.str.1 = private unnamed_addr constant [13 x i8] c"not-here.txt\00"
@.str.2 = private unnamed_addr constant [8 x i8] c"removed\00"

define i32 @main() {
  %1 = getelementptr inbounds [13 x i8], ptr @.str.1, i64 0, i64 0
  %2 = call %enum.FsWriteResult @pinggen_fs_remove(ptr %1)
  %3 = extractvalue %enum.FsWriteResult %2, 0
  %4 = icmp eq i64 %3, 0
  br i1 %4, label %match_arm.3, label %match_check.4
match_arm.3:
  %5 = getelementptr inbounds [8 x i8], ptr @.str.2, i64 0, i64 0
  %6 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %7 = call i32 (ptr, ...) @printf(ptr %6, ptr %5)
  br label %match_end.1
match_check.4:
  %8 = icmp eq i64 %3, 1
  br i1 %8, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %9 = extractvalue %enum.FsWriteResult %2, 1
  %10 = alloca ptr
  store ptr %9, ptr %10
  %11 = load ptr, ptr %10
