...
@.str.1 = private unnamed_addr constant [11 x i8] c"shared-dir\00"
@.str.2 = private unnamed_addr constant [11 x i8] c"shared-dir\00"
@.str.3 = private unnamed_addr constant [10 x i8] c"exists-ok\00"

define i32 @main() {
  %1 = getelementptr inbounds [11 x i8], ptr @.str.1, i64 0, i64 0
...
match_arm.3:
  %5 = getelementptr inbounds [11 x i8], ptr @.str.2, i64 0, i64 0
  %6 = call %enum.FsWriteResult @pinggen_fs_create_dir(ptr %5)
  %7 = extractvalue %enum.FsWriteResult %6, 0
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %match_arm.8, label %match_check.9
match_arm.8:
  %9 = getelementptr inbounds [10 x i8], ptr @.str.3, i64 0, i64 0
  %10 = getelementptr inbounds [4 x i8], ptr @.fmt.str, i64 0, i64 0
  %11 = call i32 (ptr, ...) @printf(ptr %10, ptr %9)
  br label %match_end.6
match_check.9:
  %12 = icmp eq i64 %7, 1
  br i1 %12, label %match_arm.10, label %match_unreachable.7
match_arm.10:
  %13 = extractvalue %enum.FsWriteResult %6, 1
  %14 = alloca ptr
  store ptr %13, ptr %14
  %15 = load ptr, ptr %14
...
match_check.4:
  %18 = icmp eq i64 %3, 1
  br i1 %18, label %match_arm.5, label %match_unreachable.2
match_arm.5:
  %19 = extractvalue %enum.FsWriteResult %2, 1
  %20 = alloca ptr
  store ptr %19, ptr %20
  %21 = load ptr, ptr %20
