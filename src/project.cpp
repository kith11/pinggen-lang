...
void create_project(const std::filesystem::path& target_dir, const std::string& name) {
    ...
    main_source << "        }\n";
    main_source << "    }\n";
    main_source << "    let written = \"hello from file\\n\";\n";
    main_source << "    io::println(left);\n";
    main_source << "    io::println(right);\n";
    main_source << "    match fs::write_string(\"message.txt\", written) {\n";
    main_source << "        FsWriteResult::Ok => {\n";
    ...
    main_source << "            }\n";
    main_source << "        }\n";
    main_source << "        FsWriteResult::Err(message) => {\n";
    main_source << "            io::println(message);\n";
    main_source << "        }\n";
    main_source << "    }\n";
